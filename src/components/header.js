            ...
            <div className="user-dropdown">
              ...
              <div className="p-4 mt-2 bg-white border-drop-user">
                ...
                <div className="row">
                  ...
                  <div className="col-6 mb-3 user-dropdown-options">
                    <img src="assets/icons/check-solid.svg" /> Aprovação de
                    Pedidos
                  </div>
                  <div className="col-6 mb-3 user-dropdown-options">
                    <Link to="/Pedidos" className="user-link">
                      <img src="assets/icons/paper.svg" /> Meus Pedidos
                    </Link>
                  </div>
                  <div className="col-6 mb-3 user-dropdown-options">
                  ...
                  <div className="col-6 mb-3 user-dropdown-options">
                    <img src="assets/icons/file-import-solid.svg" /> Importar
                    Pedidos
                  </div>
                  <div className="col-6 mb-3 user-dropdown-options">
              ...
              <div className="col-9 p-0 text-align-center">
                <div>
                  <p className="cart-total mb-0">
                    TOTAL: R$ <span>7.235,00</span>
                  </p>
                </div>
                <div className="d-flex align-items-center">
                  <p className="cart-balance mb-0">
                    SALDO: R$ <span>9.000,00</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-1">
            <div className="row align-items-center justify-content-center">
              <div className="col-3">
                <img
                  src="assets/icons/align-right-solid.svg"
      ...
      <div className="d-grid floating-carts">
        ...
        >
          <CDropdownToggle className="btn-cart1">
            <img
              src="assets/icons/cart-shopping-white.svg"
              className="float-img"
            />
              ...
              <div className="row float-cart-table pt-3">
                <div className="table-cel col-12 col-md-3 m-0 p-0">
                  <div className="d-grid justify-content-center align-items-center align-content-center cel00">
                    ...
                    <p className="m-0 p-0">
                      Forma de pagmento <img src="assets/arrow-down.svg" />
                    </p>
                  </div>
                  <div className="cel0">
                    <span>Pagamento</span>
