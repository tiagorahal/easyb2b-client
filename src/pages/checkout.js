                ...
                <div className="row m-0 p-0">
                    ...
                    <p className="w-100 p-0 m-0">
                        <div class="alert mb-0">
                            ...
                            <strong>Aviso! </strong> itens acima de de R$20,00 devem ser entregues dentro do prazo estipulado.
                        </div>
                    </p>
                    {/* DETAILS ROW */}
                    <Dropdown className="p-0 d-flex">
                        <div className="col-3 d-flex align-items-center check-dropdown">
                            <Dropdown.Toggle id="dropdown-basic" align="center" className="toggle-check">
