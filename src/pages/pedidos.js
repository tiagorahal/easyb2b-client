    ...
    <div className="pedidos-main">
      <div className="pedidos container">
        <div className="row pt-4">
          <div className="row">
            <h1 className="pedidos-titulo col-7 pb-2 align-items-center">
              Pedidos Realizados
            </h1>
            <div className="col d-flex justify-content-between align-items-center">
              <a href="#" className="pedidos-link">
                <img
                  className="pedidos-icon-image"
          ...
          <form className="pedidos-form pb-2 pt-4">
            ...
            <div class="row">
              ...
              <div class="form-group col-2">
                <label for="inputZip" style={{ opacity: 0 }}>
                  gambiarra
                </label>
                <button
                  type="submit"
                  class="btn btn-primary w-100 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                >
                  BUSCAR
                </button>
              </div>
          ...
          <div className="col-9">
            <div className="d-flex flex-column">
              ...
              <div className="pedidos-buttons d-flex justify-content-between col-11 pb-3">
                <button
                  type="button"
                  class="btn btn-primary bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm"
                >
                  CLONAR PEDIDO
                </button>
                <button
                ...
                <button
                  type="button"
                  class="btn btn-success bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded text-sm"
                >
                  EDITAR
                </button>
                <button
                  type="button"
                  class="btn btn-danger bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded text-sm"
                >
                  CANCELAR
                </button>
              </div>
