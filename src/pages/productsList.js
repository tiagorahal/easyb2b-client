                    ...
                    <div className="row">
                        <div className="product-item col-md-4 col-lg-3 col-sm-6">
                            <div className="bg-white w-100 h-100">
                                ...
                                <div className="row d-flex justify-content-center"><div className="col-10 product-line"></div></div>
                                ...
                                <div className="product-list-footer p-3">
                                    <div className="row d-flex justify-content-center">
                                        ...
                                        <div className="col-7 p-0">
                                            <button className="btn-add-cart">INCLUIR NO CARRINHO</button>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-12 d-flex justify-content-end product-footer-icons">
                                            <Link><img src="assets/icons/eye-solid.svg" /></Link>
                                            <button className="favorite"><img src="assets/icons/heart-regular.svg" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
